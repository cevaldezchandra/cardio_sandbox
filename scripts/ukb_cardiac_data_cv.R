...
#mi_prs01 <- read.table("mi_prs/mi_clump_0.01.txt.clumped.prs.txt")
#mi_prs001 <- read.table("mi_prs/mi_clump_0.001.txt.clumped.prs.txt")
#mi_prs005 <- read.table("mi_prs/mi_clump_0.005.txt.clumped.prs.txt")
#mi_prs0001 <- read.table("mi_prs/mi_clump_0.0001.txt.clumped.prs.txt")
#mi_prs0005 <- read.table("mi_prs/mi_clump_0.0005.txt.clumped.prs.txt")
#mi_prs16 <- read.table("mi_prs/mi_clump_0.0000001.txt.clumped.prs.txt")
#mi_prs15 <- read.table("mi_prs/mi_clump_0.000001.txt.clumped.prs.txt")
#mi_prs14 <- read.table("mi_prs/mi_clump_0.00001.txt.clumped.prs.txt")
